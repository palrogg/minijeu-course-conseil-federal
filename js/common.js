...
Game.Load = {
  ...
  images: function(names, callback) { // load multiple images and callback when ALL images have loaded
    ...
    for(n = 0 ; n < names.length ; n++) {
      ...
      if( $.inArray(name, ['monster', 'player', 'coin', 'coins']) > -1 ){ // elements specifiques aux trois personnages
        result[name].src = "images/" + name + "_" + $('ul.player-selection li.selected').data('player') + ".png";
      }else{
